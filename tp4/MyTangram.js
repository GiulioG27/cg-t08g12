...
export class MyTangram extends CGFobject {
    ...
    var startingCoords=[0.25,0.75,0.75,0.75,0.5,0.5];
    this.triangleSmall.updateTexCoords(startingCoords);
    this.scene.tangramMaterial.apply();
    //this.red.apply();
    ...
    //this.violet.apply();
    var newCoords=[0,0,0,0.5,0.25,0.25];
