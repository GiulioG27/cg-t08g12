...
/**
* MyPlane
* @constructor//what is this doing(does it actually do something or is it just part of the comment?
 why doesn't the constructor have the same name as the class?
...
export class MyPlane extends CGFobject {
    constructor(scene, nDivs) {
        ...
        this.nDivs = nDivs; //didn't understand how we chose these
    ...
    */
    display() {
        ...
        for (var i = 0; i < this.nDivs; i++) { //haven't understood what this does
            super.display();
