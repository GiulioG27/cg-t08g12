...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'displaySelectedObject').name('Display SelectedObject');
        this.gui.add(this.scene, 'selectedObject', this.scene.objectIDs).name('Selected Object').onChange(this.scene.updateObjectComplexity.bind(this.scene));//not clear yet what this updatecomplexity does (it probably keeps updaated the object complexity when the object chosen is a differnt one as it is changable)
        ...
        this.gui.add(this.scene,'globalAmbient',0.0,1.0).name("Global Ambient Light");
        ...
        //how do these actually affect the attenuation as requested? 
        //I don't see any setConstantAttenuation() fuction or similars..
